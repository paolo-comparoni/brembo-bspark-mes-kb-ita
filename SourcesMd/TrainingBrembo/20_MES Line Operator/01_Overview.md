---
title: "Opcenter MES Training - Overview Line Operator"
...
## Modalità di training e canali di supporto
...
## Livelli della produzione: ERP, MES, operatori e automazione
...
## Come il MES rappresenta la produzione: plant modeling e process modeling
...
## Esecuzione delle attività nei Work Center
...
## Anagrafica materiali e ricezione dati da SAP
...
## Container come unità logistica e Handling Unit SAP
...
## Flusso dei container tra buffer, consumo e produzione
...
## Buffer, availability check e richiesta materiale a SAP
...
## BOM – Distinta base dei materiali
...
## Operazioni e completamento produttivo
...
## Work Order come oggetto centrale di esecuzione
...
## Team management e gestione del gruppo di lavoro
