---
title: "Opcenter MES Training - Operatività Shop Floor"
...
## Panoramica funzionalità shop floor
...
## Login e riconoscimento del Work Center
...
## Visualizzazione degli ordini nel Work Center

- Selezionato il Work Center, il sistema rende disponibili tutte le operazioni associate corredate dai rispettivi Work Order. Mostrando esclusivamente quelli in stato attivo o in pausa (le lavorazioni completate vengono escluse dalla visualizzazione).
...
## Struttura e indicatori di stato degli ordini di produzione
...
## Composizione obbligatoria del gruppo di turno
...
## Avvio dell'ordine e gestione delle quantità producibili
...
## Casting: scansione stampo, stroke, cavità e propagazione difetti
...
## Cutting: propagazione Original Batch e flusso multi-fase
...
## Consumo materiali: livelli di tracciabilità (Hard / Soft / Autoconsumo)
...
## Chiamata materiali: staging call al magazzino
...
## Gestione degli scarti: componenti, prodotto finale e cavità casting
...
## Completamento del Work Order: chiusura totale e parziale dei contenitori
...
## Documentazione operativa per Work Center e operazioni
...
## Funzioni supervisore: cronologia, non conformità e ispezioni qualità
...
## Gestione del tempo non produttivo: inserimento, associazione ordine e completamento
...
- L'operatore può collegare all'ordine l'attività non produttiva prevista nella configurazione.

- Engineering Presentation Template
- 19
- Gestione del tempo non produttivo – Associazione Ordine
- OPCENTER MES TRAINING - SHOP FLOOR
...
- Dopo aver selezionato il gruppo, viene visualizzata la lista delle attività non produttive, in questo modo fornisce la giustificazione del tempo di fermo dell'attività produttiva. Una volta terminato il momento non produttivo, l'operatore può indicarne la conclusione.

- Engineering Presentation Template
- 21
- Gestione del tempo non produttivo – Associazione e Completamento Ordine
- OPCENTER MES TRAINING - SHOP FLOOR
