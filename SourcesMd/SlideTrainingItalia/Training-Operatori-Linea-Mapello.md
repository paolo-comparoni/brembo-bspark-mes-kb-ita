...
> Documento sorgente: `E:\BremboDocs\SlideTrainingItalia\Training-Operatori-Linea-Mapello.pptx`  
> Tipo: PowerPoint (.pptx) · Slide: 40


## Slide 1: OPERATORI DI LINEA
...
## Slide 7: SELEZIONE DEL WORK CENTER
...
## Slide 10: SELEZIONE DELL’ORDINE DI LAVORAZIONE
...
## Slide 12: STATO DELL’ORDINE DI LAVORAZIONE
...
## Slide 13: AVVIO DELL’ORDINE DI LAVORAZIONE
...
## Slide 15: AVVIO DELL’ORDINE DI LAVORAZIONE – CON CONTENITORE PARZIALE
...
## Slide 18: AVVIO DELL’ORDINE DI LAVORAZIONE - GESTIONE SOVRA-PRODUZIONE (OVERTOLERANCE)

- La gestione della sovra-produzione (overtolerance) è un meccanismo di controllo progettato per impedire la produzione incontrollata di pezzi sopra la quantità nominale dell’ordine di lavorazione, garantendo che i quantitativi dichiarati non superino le soglie definite in SAP.
- Ordine Flessibile (Infinite Tolerance): SAP invia l'ordine senza limiti specifici. In questo caso, il MES permette una sovra-produzione illimitata, consentendo all'operatore di riavviare l'ordine infinite volte.
- Ordine Fisso con Tolleranza Percentuale: SAP definisce una percentuale di tolleranza (es. 10%). Il MES calcola la quantità massima avviabile applicando tale percentuale alla quantità pianificata. Se l'operatore tenta di avviare una quantità che supera il limite (Pianificato + Tolleranza), il sistema blocca l'azione con un messaggio di errore.
- Ordine Fisso con Recupero Scarti (Target Quantity): Utilizzato tipicamente in Assemblaggio. L'obiettivo è produrre esattamente la quantità nominale di pezzi buoni. Se vengono dichiarati scarti durante il processo, il sistema aggiorna automaticamente la quantità residua "da avviare", permettendo di recuperare i pezzi persi ma impedendo di produrre anche un solo pezzo in più rispetto al nominale.
- Gli utenti standard non possono forzare il superamento dei limiti di tolleranza; eventuali correzioni richiedono l'intervento del back-office o la modifica dell'ordine in SAP.

- TRAINING LINE OPERATOR - MAPELLO

- 18

- AVVIO DELL’ORDINE DI LAVORAZIONE - GESTIONE SOVRA-PRODUZIONE (OVERTOLERANCE)
